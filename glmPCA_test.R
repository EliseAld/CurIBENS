...
glmpca<-function(Y,L,fam=c("poi","nb","mult","bern"),ctl=list(maxIter=100,eps=1e-4),penalty=0.1,verbose=FALSE,init=list(factors=NULL,loadings=NULL),nb_theta=1){
...
glmPCA <- glmpca(matrix,L=5,fam="mult",verbose=T,penalty=1)

# Save obj
save(glmPCA,file="glmPCA.Robj")
